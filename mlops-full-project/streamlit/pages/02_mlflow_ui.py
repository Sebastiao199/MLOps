...
def launch_mlflow_server(reporter):
    ...
    if not st.session_state['mlflow']:
        ...
        good_process = subprocess.run(["mlflow", "server", "--host=127.0.0.1", "--port=8080","--artifacts-destination=./ml_artifacts", "--default-artifact-root=./ml_artifacts"], cwd="C://Users//sebas//OneDrive//Desktop//NovaIMS//Second_Semester//MLOps//Project//MLOps//mlops-full-project", capture_output=True, text=True)
        good_process.kill()
