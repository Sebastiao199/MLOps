...
from src.mlops_full_project.pipelines.model_selection.nodes import model_selection
...
def test_model_selection():
    ...
    parameters = {
        'hyperparameters': {
            ...
            'DecisionTreeClassifier': {'max_depth': [3, 5, 10], 'min_samples_split': [2, 5]}
        }
    }
    ...
    assert isinstance(model, RandomForestClassifier) or isinstance(model, GradientBoostingClassifier) or isinstance(model, DecisionTreeClassifier)
